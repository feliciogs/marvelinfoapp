package fegssp.app.io.marvelinfoapp.ui.adapters
...
import fegssp.app.io.marvelinfoapp.data.model.character.CharacterModel
import fegssp.app.io.marvelinfoapp.databinding.ItemCharacterBinding
import fegssp.app.io.marvelinfoapp.util.limitSize
    ...
    override fun onBindViewHolder(holder: CharacterViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            if(character.description == ""){
                ...
                tvDescriptionCharacter.text = character.description.limitSize(100)
            }
