...
import fegssp.app.io.marvelinfoapp.data.model.comics.ComicModel
import fegssp.app.io.marvelinfoapp.databinding.ItemComicBinding
...
class ComicAdapter : RecyclerView.Adapter<ComicAdapter.ComicViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ComicViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            tvDescriptionComic.text = comic.description.limitSize(100)
